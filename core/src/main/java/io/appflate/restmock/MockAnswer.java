...
interface MockAnswer {
     ...
     * return relevant {@link MockResponse}.
     *
     * @param request a http request that got matched
     * @return {@link MockResponse} for the given request.
     */
    MockResponse answer(RecordedRequest request);
}
